...
const ProductDetail = () => {
  ...
  <>
    <div className="max-w-7xl mx-auto p-8 bg-white rounded-lg shadow-lg mt-10">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        ...
        {/* Mô tả sản phẩm */}
        <p className="text-lg text-gray-900 mt-4 text-center lg:text-left">{product.mo_ta}</p>
        {/* Hình ảnh sản phẩm */}
  ...
  <div className="mt-4 flex flex-row items-center">
    <button 
      ...
      className="flex items-center justify-center px-8 py-3 bg-red-600 text-white font-semibold rounded-lg shadow-md hover:bg-red-700 transition duration-300 transform hover:scale-105 text-lg"
    >
      <FaMoneyCheckAlt className="mr-2" /> Mua ngay
    </button>
    <button
      onClick={handleAddToCart}
      className="flex items-center justify-center px-4 py-2 bg-gray-300 text-black font-medium rounded-lg shadow-sm hover:bg-gray-400 transition duration-300 ml-4 text-sm"
    >
